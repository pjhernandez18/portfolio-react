                                    ...
                                    <div class="desc">
                                        <div class="con">
                                            ...
                                            <p className="project-desc">This is an MVP version of Token, an iOS mobile app that lets users share their travel experiences by packaging their photos and videos
                                                ...
                                                in your travel experiences. (Swift, iOS camera framework (SwiftyCam), Firebase)
                                            </p>
                                            <p class="icon">
                                ...
                                <div class="project" style={{backgroundImage: 'url(images/im-hungry.png)'}}>
                                    <div class="desc">
                                        <div class="con">
                                            ...
                                            <p className="project-desc">A food and recipe recommendation app created with React, Java Jetty server, and Firebase. The app recommends 
                                            recipes and restaurants related to a keyword, and allows for the creation of shopping lists based on "favorited" restaurants and recipes, 
                                ...
                                <div class="project" style={{backgroundImage: 'url(images/thesupperclubsc.jpg)'}}>
                                    <div class="desc">
                                        ...
                                        <h3 className="project-title">The Supper Club SC</h3>
                                            ...
                                            a static site with core HTML/CSS/Bootstrap elements to display club information and events.</p>
                                            <p class="icon">
                                ...
                                <div class="project" style={{backgroundImage: 'url(images/trackchanges.png)'}}>
                                    <div class="desc">
                                        <div class="con">
                                            ...
                                            <p className="project-desc">An iOS mobile application that integrates user's Spotify accounts to share music with other registered users.
                                            (Swift, Spotify API, Java)</p>
                                            <p class="icon">
